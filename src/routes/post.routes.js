...
router.patch('/post/:postId/comment/:commenter', validate('addComment'), postController.addComment)
router.patch('/post/:postId', validate('updatePost'), postController.updatePost)
